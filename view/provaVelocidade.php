    ...
    <div class="provaVelocidade">    
        ...
        <form action="javascript:void(0)">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control distanciaProvaVelocidade" type="number" id="example-number-input">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control tempoProvaVelocidade" type="number" id="example-number-input">
                </div>
            </div>
